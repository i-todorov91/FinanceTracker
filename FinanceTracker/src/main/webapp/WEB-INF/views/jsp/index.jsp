    ...
    <div class="header_section">
      ...
      <nav class="nav" id="nav">
        <ul class="toggle">
          ...
          <li><a id="redirect-login" href="login.jsp">Login</a></li>
          <li><a id="redirect-register" href="register.jsp">Register</a></li>
        </ul>
        <ul class="">
          <li><a href="#top_content">Home</a></li>
          <li><a href="#service">Services</a></li>
          ...
          <li><a id="redirect-register" href="registerpage">Register</a></li>
        </ul>
      </nav>
